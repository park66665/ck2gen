...
namespace CrusaderKingsStoryGen
{
    ...
    public string ModifyName(string input)
      ...
      static List<String> choices = new List<string>();
        ...
        {
            if (maleNameBlockSet.Count == 0)
                maleNameBlockSet = GetMaleNameBlockCSV();

            return maleNameBlockSet[Rand.Next(maleNameBlockSet.Count)];
        ...
        {
            if (femaleNameBlockSet.Count == 0)
                femaleNameBlockSet = GetFemaleNameBlockCSV();

            return femaleNameBlockSet[Rand.Next(femaleNameBlockSet.Count)];
        }
