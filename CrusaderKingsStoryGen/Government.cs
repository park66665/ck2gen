...
namespace CrusaderKingsStoryGen
{
    class Government
    {
        ...
        public void Save(ScriptScope scriptScope)
        {
            ...
            foreach (var cultureParser in cultureGroupAllow)
            {
                cultureBlock += "culture_group = " + cultureParser + @"
                ";
            }

            if (cultureGroupAllow.Count == 0)
                return;
            ...
            scriptScope.Do(@"
                ...
                can_build_hospitals = " + (can_build_hospitals ? "yes" : "no") + @"
        ...
        public void SetType(string type)
        {
            ...
            switch (type)
            {
                ...
                case "feudal":
                    ...
                    allowed_holdings.Add("FORT");
                    allowed_holdings.Add("HOSPITAL");
                    preferred_holdings.Add("CASTLE");
                    can_build_hospitals = true;
